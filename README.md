...
<h2>Demo 📷</h2>
<div display='flex'> 
  <img width='75%' src='public/readmeMedia/desktop.gif' alt='Gif showing the home page in desktop mode'/>
  <img width='30%' src='public/readmeMedia/mobile.gif' alt='Gif showing the home page in mobile mode'/>
</div>
<hr/>
<h2>Publicação</h2>
